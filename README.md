...
- **Automated Trading** — Real execution via Korea Investment & Securities or Toss Securities API
  (pick one with `PRISM_BROKER`; see [Toss setup](docs/TOSS_BROKER_SETUP.md))
...
| **Auto Trading** | Execution via Korea Investment & Securities or Toss Securities API (`PRISM_BROKER`) |
